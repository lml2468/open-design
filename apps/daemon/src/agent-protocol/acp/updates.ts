 ...
 * artifact-write detection, and tool event projection. Depends on acp/types
 * and acp/json; consumed exclusively by acp/session.ts.
 */
...
/**
 * Returns `true` when the tool is pure think/reason activity and should be
 * omitted from the tool_use/tool_result transcript.
 */
